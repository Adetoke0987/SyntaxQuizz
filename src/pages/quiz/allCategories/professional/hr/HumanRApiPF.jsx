...
function HumanRApiPF() {
  ...
  useEffect(() => {
    fetch('https://questionsapi-1.onrender.com/api/quiz')
      ...
      .then(data => {
        ...
        const accountingQuestions = data.find(category => category.category === "HumanResources");
  ...
  return (
    <div className="app">
      <h1 className="title">Human Resources Session</h1>
